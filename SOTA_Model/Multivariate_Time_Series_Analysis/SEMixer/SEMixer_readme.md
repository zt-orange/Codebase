...
![步骤一](images\SEMixer_readme\1.png) 
<br/><br/>

因为代码有一段是初始化，由于将其他模型给删除了，所以初始化会报错误，故需要进行修改（将圈内代码进行删除），如下图：

![步骤一](images\SEMixer_readme\2.png) 
...
![步骤一](images\SEMixer_readme\3.png) 
...
![步骤一](images\SEMixer_readme\4.png) 
...
![步骤一](images\SEMixer_readme\5.png) 
只需要在run.py中新增一行就可以解决问题：
```
